...
Model_cfg = dict(
    model_cfg_name="DinoVisionTransformer_DAR_distill_Seg_Config",
    model_cfg_args=dict(
        
        pretrained_weights = './model_weights/dinov2_vitb14_pretrain_new.pth',
        # finetune_weights = './model_weights/dinov2_b_dar_distill_duts.pth',
        ...
        loss_decode=[
            ...
            dict(
                loss_type='DARCosSimilarityLoss', 
                reduction='mean', 
                loss_weight=0.1, 
                loss_name='d_reg_loss_cosloss',
            ),
